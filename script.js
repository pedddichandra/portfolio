...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            hero_intro_1: "Hi, I'm",
            hero_name: "Sathvik Chandra Peddi",
            hero_intro_2: "An Aspiring Data Analyst & Data Scientist skilled in Python, Machine Learning, Data Analysis, and Visualization.",
        ...
        te: {
            ...
            hero_name: "సత్విక్ చంద్ర పెద్ది",
            hero_intro_2: "Python, మెషిన్ లెర్నింగ్, డేటా అనాలిసిస్ మరియు విజువలైజేషన్‌లో నైపుణ్యం కలిగిన ఆకాంక్ష డేటా అనలిస్ట్ & డేటా సైంటిస్ట్.",
        ...
        hi: {
            ...
            hero_name: "सत्विक चंद्र पेड्डी",
            hero_intro_2: "Python, मशीन लर्निंग, डेटा एनालिसिस और विजुअलाइजेशन में कुशल एक आकांक्षी डेटा एनालिस्ट और डेटा साइंटिस्ट।",
